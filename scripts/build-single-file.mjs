...
const [html, css, config, seedData, app] = await Promise.all([
  readFile("index.html", "utf8"),
  readFile("styles.css", "utf8"),
  readFile("config.js", "utf8"),
  readFile("data/seed/rankbites_seed_data.js", "utf8"),
...
const inline = html
  ...
  .replace('<script src="/data/seed/rankbites_seed_data.js" defer></script>', `<script>\n${seedData}\n</script>`)
